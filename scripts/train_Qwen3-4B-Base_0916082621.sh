##### Auto-generated 2025-09-16 08:26:21 #####
# Model     : Qwen3-4B-Base
# LoRA mode : true
# KD mode   : true
# KD ratio  : 0.5
...
mkdir -p "/workspace/LLM-NEO-bk/results/0916/result-Qwen3-4B-Base-0916/B-kd-T-Qwen/Qwen3-14B-2k-lora-rank128-lr0.0002-Shadow_2k"
cd "/workspace/LLM-NEO-bk"
llamafactory-cli train \
  --model_name_or_path "Qwen/Qwen3-4B-Base" \
  --stage sft \
  ...
  --cutoff_len 4096 \
  --max_samples 2000 \
  --output_dir "/workspace/LLM-NEO-bk/results/0916/result-Qwen3-4B-Base-0916/B-kd-T-Qwen/Qwen3-14B-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --per_device_train_batch_size 2 \
  --gradient_accumulation_steps 16 \
  --learning_rate 0.0002 \
  --num_train_epochs 1 \
...
mkdir -p "/workspace/LLM-NEO-bk/results/0916/result-Qwen3-4B-Base-0916/I-kd-T-Qwen/Qwen3-14B-2k-lora-rank128-lr0.0002-Shadow_2k"
cd "/workspace/LLM-NEO-bk"
llamafactory-cli train \
  --model_name_or_path "Qwen/Qwen3-4B" \
  --stage sft \
  ...
  --cutoff_len 4096 \
  --max_samples 2000 \
  --output_dir "/workspace/LLM-NEO-bk/results/0916/result-Qwen3-4B-Base-0916/I-kd-T-Qwen/Qwen3-14B-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --per_device_train_batch_size 2 \
  --gradient_accumulation_steps 16 \
  --learning_rate 0.0002 \
  --num_train_epochs 1 \
