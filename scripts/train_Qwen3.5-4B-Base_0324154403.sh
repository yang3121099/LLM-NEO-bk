...
mkdir -p "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/B-2k-lora-rank128-lr0.0002-Shadow_2k"
...
llamafactory-cli train \
  ...
  --cutoff_len 4096 \
  --max_samples 2000 \
  --output_dir "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/B-2k-lora-rank128-lr0.0002-Shadow_2k" \
...
mkdir -p "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/I-2k-lora-rank128-lr0.0002-Shadow_2k"
cd "/home/user/LLM-NEO-bk"
llamafactory-cli train \
  ...
  --cutoff_len 4096 \
  --max_samples 2000 \
  --output_dir "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/I-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --per_device_train_batch_size 2 \
  --gradient_accumulation_steps 16 \
  --learning_rate 0.0002 \
  --num_train_epochs 1 \
...
mkdir -p "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/B-2k-lora-rank128-lr0.0002-Shadow_2k/merged-B2I"
python3 /home/user/LLM-NEO-bk/src/shadow/merge_lora.py \
  --adapter_path "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/B-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --target_base "Qwen/Qwen3.5-4B" \
  --merge_tag "B2I" \
  --template "qwen3"

### Merge: I2I (adapter=I, target=I) ###
mkdir -p "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/I-2k-lora-rank128-lr0.0002-Shadow_2k/merged-I2I"
python3 /home/user/LLM-NEO-bk/src/shadow/merge_lora.py \
  --adapter_path "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/I-2k-lora-rank128-lr0.0002-Shadow_2k" \
  --target_base "Qwen/Qwen3.5-4B" \
  --merge_tag "I2I" \
  --template "qwen3"

### Merge: I2B (adapter=I, target=B) ###
# mkdir -p "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/I-2k-lora-rank128-lr0.0002-Shadow_2k/merged-I2B"
# python3 /home/user/LLM-NEO-bk/src/shadow/merge_lora.py \
#   --adapter_path "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/I-2k-lora-rank128-lr0.0002-Shadow_2k" \
...
# mkdir -p "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/B-2k-lora-rank128-lr0.0002-Shadow_2k/merged-B2B"
# python3 /home/user/LLM-NEO-bk/src/shadow/merge_lora.py \
#   --adapter_path "/home/user/LLM-NEO-bk/results/0324/result-Qwen3.5-4B-Base-0324/B-2k-lora-rank128-lr0.0002-Shadow_2k" \
#   --target_base "Qwen/Qwen3.5-4B-Base" \
#   --merge_tag "B2B" \
